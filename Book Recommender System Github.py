...
# 
# For retailers, more specifically book retailers, we can work with these big data using consumer reviews from books that was purchased, and then use those ratings to make recommendations for similar books that interests our consumers for recurring businesses and improved sales.
# 
