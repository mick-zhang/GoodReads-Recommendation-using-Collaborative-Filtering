...
# <br>
# 
# This model is an introductory model for creating a recommendation system. In the future, I will use Affinity Analysis for recommendation on cross product selling.
...
get_recommendations(d, 'Maureen', similarity = sim_distance)
